             ...
             <div class="col-lg-4">
                 <div class="position-relative mb-5 gameClick">
                     <RouterLink :to="Tr.i18nRoute({name:'deposit'})">
                         <img class="img-fluid rounded-3 mb-3" src="../assets/img/9.png"  />
             ...
             <div class="col-lg-4">
                 <div class="position-relative mb-5 gameClick">
                     <RouterLink :to="Tr.i18nRoute({name:'depositpg'})">
                         <img class="img-fluid rounded-3 mb-3" src="../assets/img/1.png"  />
             ...
             <div class="col-lg-4">
                 <div class="position-relative mb-5 gameClick">
                     <RouterLink :to="Tr.i18nRoute({name:'withdrawal'})">
                         <img class="img-fluid rounded-3 mb-3" src="../assets/img/5.png"  />
             ...
             <div class="col-lg-4">
                 <div class="position-relative mb-5 gameClick">
                     <RouterLink :to="Tr.i18nRoute({name:'transfer'})">
                         <img class="img-fluid rounded-3 mb-3" src="../assets/img/8.png"  />
             ...
             <div class="col-lg-4">
                 <div class="position-relative mb-5 gameClick">
                     <RouterLink :to="Tr.i18nRoute({name:'bank'})">
                         <img class="img-fluid rounded-3 mb-3" src="../assets/img/4.png"  />
             ...
             <div class="col-lg-4">
                 <div class="position-relative mb-5 gameClick">
                     <RouterLink :to="Tr.i18nRoute({name:'password'})">
                         <img class="img-fluid rounded-3 mb-3" src="../assets/img/3.png"  />
             ...
             <div class="col-lg-4">
                 <div class="position-relative mb-5 gameClick">
                     <RouterLink :to="Tr.i18nRoute({name:'history'})">
                         <img class="img-fluid rounded-3 mb-3" src="../assets/img/2.png"  />
             ...
             <div class="col-lg-4">
                 <div class="position-relative mb-5 gameClick">
                     <RouterLink :to="Tr.i18nRoute({name:'voucher'})">
                         <img class="img-fluid rounded-3 mb-3" src="../assets/img/6.png"  />
             ...
             <div class="col-lg-4">
                 <div class="position-relative mb-5 gameClick">
                     <RouterLink :to="Tr.i18nRoute({name:'referrer'})">
                         <img class="img-fluid rounded-3 mb-3" src="../assets/img/7.png"  />
